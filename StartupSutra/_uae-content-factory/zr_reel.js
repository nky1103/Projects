module.exports = {
  ...
  scenes:[
    ...
    {type:'bignum',t0:2.5,t1:5.0,size:'sm',kick:'The same AED 1,000,000 buys',num:'263 ft²',subnum:'on Palm Jumeirah.'},
    ...
    {type:'bars',t0:8.0,t1:14.0,kick:'AED 1M buys you',title:'Space, by zone',data:[
      {lbl:'Intl City',v:1370,disp:'1,370 ft²'},{lbl:'Palm',v:263,disp:'263 ft²',muted:true}]},
